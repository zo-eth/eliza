...
// import { defaultActions } from "@ai16z/eliza";
import { createGoal, getGoals } from "@ai16z/eliza";
import {
    Goal,
    GoalStatus,
    IAgentRuntime,
    ...
    test("Goal status updated to FAILED based on conversation", async () => {
        await runAiTest(
            ...
            async () => {
                ...
                await TEST_EVALUATOR.handler(runtime, message, {} as State, {
                    onlyInProgress: false,
                });
